...
def train_model():
    ...
    fruit_model.add(Conv2D(64, kernel_size=(3, 3),activation='linear',padding='same',input_shape=(100,100,3)))
    ...
    fruit_model.add(Dense(16000, activation='linear'))
    fruit_model.add(LeakyReLU(alpha=0.1))
    fruit_model.add(Dropout(0.5)) 
    ...
    fruit_model.save("fruits_new.h5")
